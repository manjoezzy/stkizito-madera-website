        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100">
          <div className="flex flex-col lg:flex-row">
            ...
            >
              ...
              {/* Mobile step indicator (inside sidebar, hidden on mobile since aside is hidden) */}
            </aside>
            ...
            <div className="flex-1 p-4 sm:p-6 lg:p-10">
              ...
              {/* Navigation Buttons */}
              {!submitted && (
                <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-100 sticky bottom-0 bg-white pb-2 -mx-4 sm:-mx-6 lg:-mx-10 px-4 sm:px-6 lg:px-10 z-50 shadow-[0_-2px_12px_rgba(0,0,0,0.06)]">
                  <Button
                    variant="outline"
                    onClick={goPrev}
